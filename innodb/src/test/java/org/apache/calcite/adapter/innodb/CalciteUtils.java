...
public class CalciteUtils {
  public static final RelDataTypeSystem relDataTypSystem = new RelDataTypeSystemImpl() {
  };
  ...
  public static SchemaPlus registerRootSchema() {
    ...
    rootSchema.add("USERS", new AbstractTable() {
      ...
      public RelDataType getRowType(RelDataTypeFactory typeFactory) {
        ...
        builder.add("ID",new BasicSqlType(relDataTypSystem,SqlTypeName.INTEGER));
        builder.add("NAME",new BasicSqlType(relDataTypSystem,SqlTypeName.CHAR));
        builder.add("AGE",new BasicSqlType(relDataTypSystem,SqlTypeName.INTEGER));
    ...
    rootSchema.add("JOBS", new AbstractTable() {
      ...
      public RelDataType getRowType(RelDataTypeFactory typeFactory) {
        ...
        builder.add("ID",new BasicSqlType(relDataTypSystem,SqlTypeName.INTEGER));
        builder.add("NAME",new BasicSqlType(relDataTypSystem,SqlTypeName.CHAR));
        builder.add("COMPANY",new BasicSqlType(relDataTypSystem,SqlTypeName.CHAR));
        return builder.build();
      }
    });
    return rootSchema;
